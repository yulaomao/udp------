 ...
 *
 * \deprecated Please use the #ftkSetRigidBody function.
 *
 ...
 */
ATR_EXPORT ftkError ftkSetGeometry( ftkLibrary lib, uint64 sn, ftkGeometry* geometryIn );
 ...
 * The system will try to match the registered geometry with the raw data.
 * Adding a geometry is immediate. You can remove a geometry with
 * ftkClearGeometry() or enumerate them with ftkEnumerateRigidBodies().
 *
 * \if STK
 * When using a spryTrack, the geometry will be sent to the devices.
 * This way, the marker detection will operate whether onboard processing
 ...
 * is strictly lower than 3 or larger than the maximum number of points.
 */
ATR_EXPORT ftkError ftkSetRigidBody( ftkLibrary lib, uint64 sn, ftkRigidBody* geometryIn );
 ...
 *
 * \deprecated Please use the #ftkEnumerateRigidBodies function.
 *
