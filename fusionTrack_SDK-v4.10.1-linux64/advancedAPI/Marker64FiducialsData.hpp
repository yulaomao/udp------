/** \file Marker64FiducialsData.hpp
...
namespace atracsys
{
    ...
    /** \brief Class holding the information for a 64-fiducials marker.
     *
     * This class contains all the information about a 64-fiducials marker. The instance does know if it has
     * been properly set (i.e. whether its member values make sense).
     *
     * The instance contains \e copies of all FiducialData instances used to reconstruct the marker.
     */
    class Marker64FiducialsData
    {
    public:
         ...
         */
        Marker64FiducialsData( const Marker64FiducialsData& other ) = default;

        /** \brief Move-constructor.
         *
         * \param[in] other instance to move to the current one.
         */
        Marker64FiducialsData( Marker64FiducialsData&& other ) = default;

        /** \brief Destructor, virtual for a proper destruction sequence.
         */
        virtual ~Marker64FiducialsData() = default;
         ...
         */
        Marker64FiducialsData& operator=( const Marker64FiducialsData& other ) = default;
         ...
         * \retval *this as a reference.
         */
        Marker64FiducialsData& operator=( Marker64FiducialsData&& other ) = default;
         ...
         * \retval false if not.
         */
        bool operator==( const Marker64FiducialsData& other ) const;
    ...
    protected:
         ...
         *
         * This constructor promotes a ::ftkMarker instance into a Marker64FiducialsData one.
         *
         ...
         */
        explicit Marker64FiducialsData( const ftkMarker64Fiducials& marker,
                                        uint32 idx,
                                        const std::array< FiducialData, FTK_MAX_FIDUCIALS_64 >& fids );
         ...
         */
        std::array< FiducialData, FTK_MAX_FIDUCIALS_64 > _FiducialInstances{};
