/** \file AdditionalDataStructures.hpp
 * \brief File defining all the frame-related data structures of the C++ API.
 *
 * This file is a collection of all frame-related data structures used in the C++ API.
 */
#pragma once
